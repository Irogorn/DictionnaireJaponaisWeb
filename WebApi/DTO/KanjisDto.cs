namespace WebApi.DTO
{
    ...
    {
        public KanjisDto(int jlpt, string kanji1, int nbStrokes, string on, string onKa, string onRo, string kun, string kunRo, string sKun, string sKunRo, 
                        string sOn, string sOnKa, string sOnRo, string sKun2, string sKunRo2, string sOn2, string sOnKa2, string sOnRo2, string sKun3, string sKunRo3, KanjisFrDto kanjisFrDto)
        {
            Jlpt = jlpt;
            Kanji1 = kanji1;
            NbStrokes = nbStrokes;
            ...
            SKun3 = sKun3;
            SKunRo3 = sKunRo3;
            KanjisFrDto = kanjisFrDto;
        }

        public int Jlpt { get; set; }
        public string Kanji1 { get; set; }
        public int NbStrokes { get; set; }
        ...
        public KanjisFrDto KanjisFrDto { get; set; }
    }
}
