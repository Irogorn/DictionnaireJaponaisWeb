...
namespace WebApi
{
    public partial class FormVerb
    {
        ...
        public string CausativeHi { get; set; } = null!;
        public string Volutive { get; set; } = null!;
        public string VolutiveHi { get; set; } = null!;
        public string Conditionnel { get; set; } = null!;
        public string ConditionnelHi { get; set; } = null!;
        public string ConditionnelPa { get; set; } = null!;
        public string ConditionnelPaHi { get; set; } = null!;
        public string Obligation { get; set; } = null!;
        public string ObligationHi { get; set; } = null!;
