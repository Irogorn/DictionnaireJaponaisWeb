...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-TFKSMCP;Initial Catalog=JapaneseDictionary;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            /*modelBuilder.Entity<FormAdj>(entity =>
            {
                ...
                entity.Property(e => e.ConditionnelHi)
                    .HasMaxLength(50)
                ...
                entity.Property(e => e.ConditionnelPaHi)
                    .HasMaxLength(50)
            ...
            modelBuilder.ApplyConfiguration(new FormAdjConfiguration());
            ...
            /*modelBuilder.Entity<FormVerb>(entity =>
            {
                ...
                entity.Property(e => e.CausativeHi)
                    .HasMaxLength(50)
                ...
                entity.Property(e => e.ObligationHi)
                    .HasMaxLength(50)
                ...
                entity.Property(e => e.VolutiveHi)
                    .HasMaxLength(50)
                    .HasColumnName("volutive_hi");
            });*/
            modelBuilder.ApplyConfiguration(new FormVerbConfiguration());
            ...
            /*modelBuilder.Entity<Kanji>(entity =>
            {
                ...
                entity.Property(e => e.NbStrokes).HasColumnName("nb_strokes");
            ...
            modelBuilder.ApplyConfiguration(new KanjiConfiguration());
            ...
            modelBuilder.ApplyConfiguration(new KanjisFrConfiguration());
            ...
            modelBuilder.ApplyConfiguration(new WordsFrConfiguration());
